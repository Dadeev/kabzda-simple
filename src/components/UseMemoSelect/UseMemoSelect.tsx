...
import s from './UseMemoSelect.module.css'
...
type UseMemoSelectPropsType = {
    value: any
    onChange: (value: any) => void
    items: ItemType[]
}

export const UseMemoSelect = (props: UseMemoSelectPropsType) => {
    console.log('UseMemoSelect is rendering')
